...
#initialize the presentation
		...
		notes = []
		#add:
		#tts = ALProxy("ALAnimatedSpeech", "192.168.1.142", 9559)
		tts = ALProxy("ALAnimatedSpeech", str(my_ip), 9559)
		self.app.evaluate_javascript("document.getElementById('presentation_image').style.display='block'")
		self.app.evaluate_javascript("document.getElementById('presentation_content').innerHTML = 'Log:<br>Starting presentation at: %s<br>IP: %s<br>Notes:'" %(my_path, my_ip))
